...
export default function HeroSection() {
  ...
  const resumeUrl = "https://drive.google.com/file/d/1BPUNEgcYnAtV7P1o-IBsy3XoMXjkGs7M/view?usp=sharing"
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-16 items-center">
          ...
          <div>
            ...
            >
              I'm a full-stack developer and AI/ML engineer creating enhanced solutions and crafting thoughtful user experiences.
            </motion.p>
