...
export default function ContactSection() {
  ...
  const checkServerStatus = useCallback(async (retries = 1) => {
    // Only run health check once on mount and manually when form is submitted
    const now = Date.now();
    if (lastCheck > 0 && (now - lastCheck) < 300000) { // 5 minutes cooldown
      return;
    }
  ...
  const sendEmail = async (e) => {
    ...
    try {
      // Only check server status if we haven't checked recently
  ...
  // Remove this function as it's redundant with sendEmail and causing infinite loops
  // The sendEmail function already handles form submission
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-16 items-center">
          ...
          >
            ...
            >
              I'm currently available for work and freelance opportunities. 
