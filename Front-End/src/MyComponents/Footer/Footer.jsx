...
export default function Footer() {
  const socialLinks = [
    { 
      name: 'LinkedIn',
      url: 'www.linkedin.com/in/tanishq-raj',
      icon: <Linkedin className="w-5 h-5" />
    },
    { 
      name: 'GitHub',
      url: 'https://github.com/Tanishq-Raj',
    ...
    <footer className="bg-black text-white py-16 md:py-24 relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          {/* Column 1 - Brand */}
          <div>
            <h2 className="text-2xl font-bold mb-6">tanishq<span className="text-gray-400">.dev</span></h2>
        ...
        <div className="border-t border-gray-800 mt-16 pt-8 flex flex-col md:flex-row justify-between items-center">
          <div className="text-gray-500 text-sm mb-4 md:mb-0">
            <p>© {currentYear} Tanishq Raj. All rights reserved.</p>
